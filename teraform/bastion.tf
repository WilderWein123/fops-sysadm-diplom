resource "yandex_compute_instance" "bastion" {
  ...
  scheduling_policy {
    ...
    network_interface {
     ...
     nat = true
     security_group_ids =  [ yandex_vpc_security_group.out_all.id, yandex_vpc_security_group.inc_ssh_global.id, yandex_vpc_security_group.local_all.id, yandex_vpc_security_group.in_all.id ]
  }
