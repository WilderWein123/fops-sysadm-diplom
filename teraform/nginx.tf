resource "yandex_compute_instance" "nginx" {
  ...
  network_interface {
     ...
     nat = false
     security_group_ids = [ yandex_vpc_security_group.out_all.id, yandex_vpc_security_group.inc_http.id, yandex_vpc_security_group.inc_http.id, yandex_vpc_security_group.inc_zbxagent.id, yandex_vpc_security_group.inc.inc_ssh.id ]
  }
