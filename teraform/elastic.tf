resource "yandex_compute_instance" "elastic" {
  ...
  network_interface {
     ...
     security_group_ids = [ yandex_vpc_security_group.out_all.id, yandex_vpc_security_group.inc_elk.id, yandex_vpc_security_group.local_all.id, yandex_vpc_security_group.in_all.id ]
  }
